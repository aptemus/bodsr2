---
title: "Combining real-time location data with timetable data using bodsr2"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Combining real-time location data with timetable data using bodsr2}
...
`get_siri_vm()` with GTFS timetable data loaded via `gtfs_load()` to
place a bus precisely on its route — identifying which stop it is
...
See the [BODS GTFS caching vignette](bods-gtfs-caching.html) for details
on how the caching layer works.
